class ytb_xs {
     ...
     * --- --- --
     * @param {{apiKey:string}} YoutubeAPIConfig
	...
	constructor(YoutubeAPIConfig) {
		this.apiKey = YoutubeAPIConfig.apiKey;
		...
		this.GET = {
			...
			channelByUsername: async (username) => {
			...
			lastVideoByUsername: async (username) => {
